...
public class check {
    private static final String POST_URL = "https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic?access_token=" + Auth.getAuth();
    ...
    public static void main(String[] args) {
        String path = "/Users/yingfc/Desktop/bilibili.png";
        try {
